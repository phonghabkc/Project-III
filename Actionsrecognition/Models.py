...
class GraphConvolution(nn.Module):
    ...
    def forward(self, x, A):
        ...
        x = torch.einsum('nkctv,kvw->nctw', (x, A.repeat(1, 2, 2)[:,:23,:23]))
...
class StreamSpatialTemporalGraph(nn.Module):
    ...
    def __init__(self, in_channels, graph_args, num_class=None,
        ...
        self.data_bn.running_var.requires_grad = False
        self.data_bn.running_mean.requires_grad = False

        # Thêm dòng mã sau:
        self.data_bn.weight.requires_grad = False
        self.data_bn.bias.requires_grad = False
